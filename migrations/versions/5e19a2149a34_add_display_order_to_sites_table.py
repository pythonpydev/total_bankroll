...
def upgrade():
    ...
    # Step 4: Add the default_currency_code column and foreign key to the users table
    with op.batch_alter_table('users', schema=None) as batch_op:
        batch_op.add_column(sa.Column('default_currency_code', sa.String(length=3), nullable=False, server_default='USD'))
