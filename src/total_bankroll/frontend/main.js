 ...
 * This file is managed by Vite and bundles all the application's JavaScript.
 */

// Import utility scripts so Vite can bundle them.
import './chart_utils.js';
import './card_utils.js';
            ...
            fetch(url)
                ...
                .then(html => {
                    ...
                    if (form) {
                        ...
                        // IMPORTANT: Add an event listener to handle the form submission manually
                        form.addEventListener('submit', function(e) {
                            e.preventDefault(); // Stop the default browser submission
                            const formData = new FormData(form);
                            const actionUrl = form.getAttribute('action');

                            // Manually submit the form data to the correct action URL
