...
def init_oauth(app):
    ...
    try:
        ...
        logger.warning("flask_dance.contrib.google not available. Google login disabled.")
    ...
    try:
        ...
        logger.warning("flask_dance.contrib.facebook not available. Facebook login disabled.")
    ...
    try:
        ...
        def facebook_logged_in(blueprint, token):
            try:
                ...
                email = user_info.get("email")
                if not email:
                    flash("Email not provided by Facebook.", 'danger')
                    logger.error(f"Email missing in Facebook OAuth callback. Info: {user_info}")
                    return redirect(url_for("auth.login"))
        ...
        logger.warning("Facebook OAuth blueprint not defined. Skipping Facebook callback.")
